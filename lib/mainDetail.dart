...
//                   child: Container(                
//      child: Center(child: WidgetHelper.text( snapshots.data.docs[0]["interest"].toString().replaceAll("[","").replaceAll("]","").replaceAll(",", "  |  "), 18,Colors.black)),
//                     height: 40,
//                     decoration: BoxDecoration(
...
//      ),
//      height: 30,decoration: BoxDecoration(borderRadius: BorderRadius.circular(9),color: Colors.white),),),
// ],),
// Padding(
//   padding: const EdgeInsets.only(left:13.0,right: 13,top:5,bottom: 10),
//   child: GestureDetector(onTap: (){ Navigator.push( context, MaterialPageRoute( builder: (b) => chat(
//                                                             receiveruid:  snapshots.data.docs[0]["uid"],
//                                                             receivername:  snapshots.data.docs[0]['name'],
//                                                             receiverimage:  snapshots.data.docs[0]['image'],
//                                                             query:  snapshots.data.docs[0].data()
//                                                                 ,
//                                                           )));
//                     },
//                     child: Container(                
